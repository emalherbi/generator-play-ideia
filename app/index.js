...
module.exports = class extends Generator {
  ...
  addFiles() {
    this.fs.copyTpl(this.templatePath('_index.html'), this.destinationPath('app/index.html'), {
      appName: this.appName,
      includeNormalize: this.includeNormalize,
      includeJQuery: this.includeJQuery,
      includeBootstrap: this.includeBootstrap,
    });
    this.fs.copy(this.templatePath('_yeoman-logo.png'), this.destinationPath('app/img/yeoman-logo.png'));
    this.fs.copy(this.templatePath('_app.css'), this.destinationPath('app/css/app.css'));
    this.fs.copyTpl(this.templatePath('_app.js'), this.destinationPath('app/js/app.js'), { includeJQuery: this.includeJQuery });
    this.fs.copyTpl(this.templatePath('_README.md'), this.destinationPath('README.md'), { appName: this.appName });
    ...
    this.fs.copy(this.templatePath('_properties.json'), this.destinationPath('properties.json'));
  }
